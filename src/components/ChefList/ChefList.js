...
import { inputChange, inputStatus, resetState } from '../../features/bookingFormSlice'
        ...
        <section className='chef-section' >
            <div className='chef-grid-container'>
                ...
                <div className='chef-description'>
                    ...
                    <Link to={loggedInUser ? "/user/booking#" : "/login#"} name="Lisa Quinn" onClick={handleClick} >Book a meeting</Link>
                </div>
                ...
                <div className='chef-description'>
                    ...
                    <Link to={loggedInUser ? "/user/booking#" : "/login#"} name="Ben Malone" onClick={handleClick} >Book a meeting</Link>
                </div>
                ...
                <div className='chef-description'>
                    ...
                    <Link to={loggedInUser ? "/user/booking#" : "/login#"} name="Liam Pierce" onClick={handleClick} >Book a meeting</Link>
                </div>
            </div>
        </section>
